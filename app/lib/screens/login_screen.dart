...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      setState(() {
        _error = e.toString().contains('401') ? '用户名或密码错误' : '登录失败，请检查网络';
      });
    } finally {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.settings_outlined, color: XhsTheme.textSecondary),
            onPressed: () {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_error != null)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: XhsTheme.primaryRed.withValues(alpha: 0.1),
                  ...
                  TextButton(
                    ...
                    child: const Text(
                      '还没有账号？立即注册',
                      style: TextStyle(color: XhsTheme.primaryRed),
                    ),
                  ),
                ],
              ),
